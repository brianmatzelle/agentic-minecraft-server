---
name: jumbotron
description: Operate the Pokémon-stadium jumbotron live camera — move/frame the camera, screenshot its view, check health, restart pipeline layers, stream clips to the faces. Use for any jumbotron/stadium-camera/GarvisCam request. Invoked as /jumbotron <what to do>.
